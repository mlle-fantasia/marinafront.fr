						...
						<div className="container">
							<Row className="marginTop">
								<Col md={12} className=" header">
									...
									<h2 className="text-center">Testez et choisissez celle qui vous convient le mieux !</h2>
						...
						<Row className=" marginTop marginBot">
							<Col md={6}>
								<div className="cadre cadrereact">
									...
									<a href="https://pendureact.marinafront.fr" target="bank" className="text-decoration-none text-uppercase">
							...
							<Col md={6}>
								<div className="cadre cadreAngular">
									...
									<a href="https://penduangular.marinafront.fr" className="text-decoration-none text-uppercase">
									...
									<div className="details">
										...
										<p>Composants dynamiques avec l'interpolation, Property binding et Two-way binding </p>
