                            ...
                            <div className="form">
                                ...
                                <div>
                                    <div className="input formLogin">
                                        ...
                                        <input className="form-control" name="login" value={this.state.login}  type="text" onChange={this.handleChange}/>
                                    </div>
                                    <div className="input formPass">
                                        <label htmlFor="">mot de passe</label><br/>
                                        <input className="form-control" name="pass" value={this.state.pass}  type="password" onChange={this.handleChange}/>
                                    </div>
                                    <div className="formBtn">
                                        <button className="btn btn-rea-suite" onClick={this.handleSubmit}>Se connecter</button>
                                    </div>
