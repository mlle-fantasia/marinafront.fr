					...
					<Col xs={12} sm={7} md={8}>
						<Row className="quelquesMots">
							<Col xs={12} md={8} mdOffset={2} className="texte">
								...
								<p>
									Après un cursus d'études supérieures en architecture intérieure, je me suis réorientée vers l'informatique et plus
									précisément le développement web qui est devenu une passion. Ma dernière formation et mes recherches personnelles
									m'ont permis d'avoir de bonnes bases dans de nombreux langages.{" "}
								</p>
							</Col>
						</Row>
